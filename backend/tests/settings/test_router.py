...
class TestGetSettings:
    async def test_get_settings_as_admin(self, client, db_session, admin_user):
    ...
    async def test_get_settings_as_non_admin_forbidden(self, client, runner_user):
    ...
    async def test_get_settings_unauthenticated(self, client):
        """GET / without auth should return 403."""
        response = await client.get("/api/v1/settings")
        assert response.status_code == 403

    async def test_get_settings_empty(self, client, admin_user):
    ...
    async def test_get_settings_with_category_filter(self, client, db_session, admin_user):
    ...
    async def test_get_settings_response_schema(self, client, db_session, admin_user):
...
class TestPatchSettings:
    async def test_patch_settings_as_admin(self, client, db_session, admin_user):
    ...
    async def test_patch_settings_as_non_admin_forbidden(self, client, runner_user):
    ...
    async def test_patch_settings_unauthenticated(self, client):
    ...
    async def test_patch_nonexistent_key_ignored(self, client, db_session, admin_user):
    ...
    async def test_patch_empty_settings_list(self, client, admin_user):
    ...
    async def test_patch_then_get_reflects_changes(self, client, db_session, admin_user):
